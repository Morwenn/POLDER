...
////////////////////////////////////////////////////////////
    ...
    #define POLDER_LIKELY(condition) __builtin_expect(condition, true)

    #define POLDER_UNLIKELY(condition) __builtin_expect(condition, false)

#else

    #define POLDER_LIKELY(condition)

    #define POLDER_UNLIKELY(condition)
