...
TEST_CASE( "boolean Constant", "[semisymbolic][constant]" )
{
...
TEST_CASE( "Constant literals", "[semisymbolic][constant]" )
{
    static_assert(0_c == 0, "");
    static_assert(1_c == 1, "");
    static_assert(-1_c == -1, "");
...
TEST_CASE( "Constant unary operator+", "[semisymbolic][constant]" )
{
...
TEST_CASE( "Constant arithmetic operators", "[semisymbolic][constant]" )
{
...
TEST_CASE( "Constant equality operators", "[semisymbolic][constant]" )
{
...
TEST_CASE( "Constant relational operators", "[semisymbolic][constant]" )
{
...
TEST_CASE( "math functions for Constant", "[semisymbolic][constant][math]" )
{
